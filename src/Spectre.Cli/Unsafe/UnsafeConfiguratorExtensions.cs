...
namespace Spectre.Cli.Unsafe
{
    ...
    public static class UnsafeConfiguratorExtensions
    {
        ...
        public static IUnsafeConfigurator SafetyOff(this IConfigurator configurator)
        {
            ...
            {
                throw new ConfigurationException("Configurator does not support manual configuration");
            }
        ...
        public static IConfigurator SafetyOn(this IUnsafeConfigurator configurator)
        {
            ...
            {
                throw new ConfigurationException("Configurator cannot be converted to a safe configurator.");
            }
            ...
            where TSettings : CommandSettings
        {
            ...
            {
                throw new ConfigurationException($"Configurator cannot be converted to a safe configurator of type '{typeof(TSettings).Name}'.");
            }
